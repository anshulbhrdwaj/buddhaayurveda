      ...
      <div className='mx-auto grid place-items-center gap-8 py-20 md:py-32 lg:max-w-screen-xl'>
        <div className='space-y-8 text-center'>
          <Badge variant='outline' className='py-2 text-sm'>
            <span className='mr-2 text-primary'>
              <Badge>{home.badge.offer}</Badge>
            </span>
            <span> {home.badge.title} </span>
          </Badge>
          ...
          <div className='mx-auto max-w-screen-md text-center text-4xl font-bold md:text-6xl'>
            <h1>
              ...
              {/* <br/> */}
              <FlipWords
                words={home.hero.title.benifits}
                duration={1500}
                className='bg-gradient-to-r from-white to-primary bg-clip-text px-2 text-primary'
              />
              <br />
              {home.hero.title.end}
            </h1>
          ...
          <div className='space-y-4 md:space-x-4 md:space-y-0'>
            ...
            >
              <Link href='#features'>{home.hero.cta2.text}</Link>
            </Button>
          </div>
        </div>
        ...
        <div className='group relative mt-14'>
          ...
          <Image
            ...
            src={
              theme === 'light'
                ? home.hero.image.src.light
                : home.hero.image.src.dark 
            }
