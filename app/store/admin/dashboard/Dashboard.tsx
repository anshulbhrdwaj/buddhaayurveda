      ...
      <div className='stats stats-vertical my-4 inline-grid shadow md:stats-horizontal md:flex'>
        <div className='stat'>
          ...
          <div className='stat-desc'>
            <Link href='/store/admin/orders'>View sales</Link>
          </div>
        </div>
        <div className='stat'>
          ...
          <div className='stat-desc'>
            <Link href='/store/admin/orders'>View orders</Link>
          </div>
        </div>
        <div className='stat'>
          ...
          <div className='stat-desc'>
            <Link href='/store/admin/products'>View products</Link>
          </div>
        </div>
        <div className='stat'>
          ...
          <div className='stat-desc'>
            <Link href='/store/admin/users'>View users</Link>
          </div>
        </div>
      </div>
